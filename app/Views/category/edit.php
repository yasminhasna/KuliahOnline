              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" value="<?php echo $category['category_name_matakuliah']; ?>" class="form-control" name="category_name_matakuliah" placeholder="Enter category name matakuliah">
                  </div>
                  <div class="form-group">
