              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="category_name_matakuliah" placeholder="Enter category name matakuliah" value="<?php echo $inputs['category_name_matakuliah']; ?>">
                  </div>
                  <div class="form-group">
